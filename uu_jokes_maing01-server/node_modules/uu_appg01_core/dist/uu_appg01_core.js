...
if (uri.substr(-floatingVersion.length) === floatingVersion) uri = uri.substr(0, uri.length - floatingVersion.length) + "/5.15.1/";
__webpack_require__.p = uri;
module.exports = __webpack_require__(3);
var ex = module.exports;
if (ex && _typeof(ex) === "object") {
  if (!("version" in ex)) ex.version = "5.15.1";
  if (!("name" in ex)) ex.name = "uu_appg01_core".split(/[\/\\]/).pop();
  if (!("namespace" in ex)) ex.namespace = "UuApp";
}
...
module.exports = {
  get AppClient() {
    var AppClient = __webpack_require__(96);
    // support legacy API
...
var PerflogHandler = __webpack_require__(155);
var RemoteErrorHandler = __webpack_require__(162);
var TransformParametersHandler = __webpack_require__(166);
var UriHandler = __webpack_require__(170);
var CsrfTokenHandler = __webpack_require__(171);
var RetryHandler = __webpack_require__(172);
  ...
  _createClass(Config, null, [{
    ...
    value: function activateProfiles() {
      ...
      if (typeof window == "undefined") {
        ...
        var cfgDir = Object({"NAME":"uu_appg01_core","VERSION":"5.15.1","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})["CONFIG_DIR"] || Config._getDefaultConfigDir();
        var sysCfgDir = Object({"NAME":"uu_appg01_core","VERSION":"5.15.1","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})["SYS_CONFIG_DIR"] || Config._getDefaultSysConfigDir();
    ...
    value: function _getChain() {
      ...
      if (!chain) {
        ...
        if (actProf.length === 0) {
          var envProfiles = Object({"NAME":"uu_appg01_core","VERSION":"5.15.1","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})["CONFIG_PROFILE"] || "development";
          if (envProfiles) {
    ...
    value: function load() {
      ...
      try {
        if (this._fileSrc !== undefined && this._fileSrc) {
          ...
          var _data = Object({"NAME":"uu_appg01_core","VERSION":"5.15.1","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})[this._senvSrc] || "";
          this._data = this._parse(_data);
        } else if (this._menvSrc !== undefined && this._menvSrc) {
          loadedSrc = this._menvSrc;
          var regex = this._menvSrc;
          var envKeys = Object.keys(Object({"NAME":"uu_appg01_core","VERSION":"5.15.1","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""}));
          var result = {};
          envKeys.forEach(function (key) {
            if (regex.test(key)) {
              result[key.toLowerCase()] = Object({"NAME":"uu_appg01_core","VERSION":"5.15.1","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})[key];
            }
          });
          this._data = result;
        }
...
var LoggerFactory = __webpack_require__(141);
var LogLevel = __webpack_require__(136);
var MessageFormatter = __webpack_require__(138);
var StdoutOutputter = __webpack_require__(137);
var LoggerMDC = __webpack_require__(139);
module.exports = {
  Logger: Logger,
        ...
        case "b":
          {
            switch (opts) {
              case null:
              case undefined:
                result = "this._processStack(error).join(\"".concat(ENTRY_SEPARATOR, "\")");
                break;
              case "JSON":
                result = "Json.stringify(this._processStack(error).join(\"".concat(ENTRY_SEPARATOR, "\")).slice(1, -1)");
                break;
              default:
                result = "this._processStack(error).join(\"".concat(opts, "\")");
            }
            break;
          }
        case "c":
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var UntrustedCredentials = __webpack_require__(145);
...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var AuthenticationError = __webpack_require__(146);
...
var UuAppKey = /*#__PURE__*/function () {
  ...
  function UuAppKey(vendor) {
    ...
    this._app = app;
    if (app) {
      this._product += "-".concat(app);
    }
    this._subApp = subApp;
    if (subApp) {
      this._product += "-".concat(subApp);
    }
    this._asid = asid;
    this._awid = awid;
    Object.freeze(this);
  ...
  _createClass(TokenSanitizer, null, [{
    ...
    value: function processToken(token) {
      if (!token) {
        ...
        return "...".concat(token.split(".")[1], "...");
      } else {
        var partLength = Math.ceil(token.length / 5);
        return "".concat(token.substring(0, partLength), "...").concat(token.substring(token.length - partLength));
      }
    }
  }, {
    key: "processHeader",
    value: function processHeader(header) {
      ...
      var type = match[1];
      var token = match[2];
      return "".concat(type, " ").concat(this.processToken(token));
    }
  }, {
    key: "processUri",
    value: function processUri(uri) {
      ...
      var param = match[1];
      var token = match[2];
      return uri.replace("".concat(param, "=").concat(token), "".concat(param, "=").concat(this.processToken(token)));
    }
  }]);
...
module.exports = {
  Perflog: __webpack_require__(157),
  Section: __webpack_require__(158),
  SectionId: __webpack_require__(161),
  Logger: __webpack_require__(159),
  MessageFormatter: __webpack_require__(160)
};
...
var _require = __webpack_require__(98),
  ContextStore = _require.ContextStore,
  Config = _require.Config;
var Section = __webpack_require__(158);
var SectionId = __webpack_require__(161);
...
var StdoutOutputter = __webpack_require__(134).StdoutOutputter;
var MessageFormatter = __webpack_require__(160);
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ApplicationError = __webpack_require__(163);
var SystemError = __webpack_require__(165);
var _require = __webpack_require__(134),
  LoggerFactory = _require.LoggerFactory;
...
var RemoteErrorHandler = /*#__PURE__*/function () {
  ...
  _createClass(RemoteErrorHandler, [{
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              if (response.status < 400) {
                this._logger.info("Request ".concat(request.uri, " ended with status code: ").concat(response.status));
              }
              if (!(response.status >= 400)) {
                _context.next = 14;
                break;
              ...
              this._logger.warn("Request ".concat(request.uri, " ended with status code: ").concat(response.status).concat(this._addUuAppErrorMap(response)));
              throw new ApplicationError(errorData, response);
            case 12:
              this._logger.error("Request ".concat(request.uri, " failed with status code: ").concat(response.status).concat(this._addUuAppErrorMap(response)));
    ...
    value: function _addUuAppErrorMap(response) {
      ...
      var optionalMessage = ", uuAppErrorMap code: ".concat(errorCode, ", message: ").concat(foundError.message);
      if (foundError.paramMap) {
        optionalMessage += ", paramMap: ".concat(JSON.stringify(foundError.paramMap));
      }
...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var RemoteError = __webpack_require__(164);
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ContentTransformers = __webpack_require__(167);
var _require = __webpack_require__(98),
  Config = _require.Config,
...
var MultiPart = __webpack_require__(168);
var dotNotate = __webpack_require__(169);
var logger;
  ...
  _createClass(ContentTransformers, null, [{
    ...
    value: function _stringify(key, value, result, topLevel) {
      if (Array.isArray(value)) {
        ...
        for (var k in value) ContentTransformers._stringify("".concat(key).concat(topLevel ? "" : ".").concat(k), value[k], result, false);
      } else {
...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var RetryHandlerCore = __webpack_require__(173);
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var Helpers = __webpack_require__(131);
var InvalidParameters = __webpack_require__(174);
var _require = __webpack_require__(134),
  LoggerFactory = _require.LoggerFactory;
var _require2 = __webpack_require__(98),
  Json = _require2.Json;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              this._logger.error("Request failed. Retry conditions valid, retrying the request in ".concat(sleepTime, "ms. originalRequestId=").concat(this._originalRequestId, ", originalResponseStatus=").concat(response.status, ", requestUri=").concat(request.uri.toString(), ", originalResponseData=").concat(Json.stringify(response.data), ", attempt=").concat(this._attempt, ", retryPolicy=").concat(Json.stringify(this._options)));
              _context2.next = 13;
      ...
      var _processRetryPolicyForClientErrors2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(request, options, exception) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 3:
              sleepTime = this._getRandomIntInclusive(0, Math.min(this._options.maxTimeInterval, this._options.baseTimeInterval * Math.pow(2, this._attempt)));
              this._logger.error("Request failed. Retry conditions valid, retrying the request in ".concat(sleepTime, "ms. originalRequestId=").concat(this._originalRequestId, ", attempt=").concat(this._attempt, ", retryPolicy=").concat(Json.stringify(this._options)));
              _context3.next = 7;
              return this._timeout(sleepTime);
            case 7:
              _context3.prev = 7;
...
var Uri = __webpack_require__(177);
var UriBuilder = __webpack_require__(178);
var InvalidUriPartError = __webpack_require__(180);
module.exports = {
  Uri: Uri,
...
var _require = __webpack_require__(98),
  BaseError = _require.BaseError;
var Uri = __webpack_require__(177);
var UriParser = __webpack_require__(179);
...
var SCHEME_REGEXP = new RegExp("^".concat(SCHEME, "$"));
var HOSTNAME_REGEXP = new RegExp("^".concat(HOSTNAME, "$"));
var PORT_REGEXP = new RegExp("^".concat(PORT, "$"));
var GATEWAY_REGEXP = new RegExp("^".concat(GATEWAY, "$"));
var VENDOR_REGEXP = new RegExp("^".concat(VENDOR, "$"));
var APP_REGEXP = new RegExp("^".concat(APP, "$"));
var SUB_APP_REGEXP = new RegExp("^".concat(SUB_APP, "$"));
var SPP_REGEXP = new RegExp("^".concat(SPP, "$"));
var PRODUCT_REGEXP = new RegExp("^".concat(PRODUCT, "$"));
var TID_REGEXP = new RegExp("^".concat(TID, "$"));
var AWID_REGEXP = new RegExp("^".concat(AWID, "$"));
var WORKSPACE_REGEXP = new RegExp("^".concat(WORKSPACE, "$"));
var USE_CASE_REGEXP = new RegExp("^".concat(USE_CASE, "$"));
var PARAMETER_NAME_DECODED_REGEXP = new RegExp("^".concat(PARAMETER_NAME_DECODED, "$"));
