...
class SysAppClientTokenAbl {
  ...
  async removeKeys(awid) {
    await SysAppSecretStoreAbl.removeSecret(awid, SECRET_SET, PRIVATE_KEY_CODE);
    await SysAppSecretStoreAbl.removeSecret(awid, SECRET_SET, PUBLIC_KEY_CODE);
  }
