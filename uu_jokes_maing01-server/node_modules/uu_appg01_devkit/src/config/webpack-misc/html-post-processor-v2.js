...
class HtmlPostProcessorV2 extends HtmlPostProcessorV1 {
  processHead(template, opts = {}) {
    let { appAssetsRelativeUrlPath, externals, isCdnDisabled } = this._config;
    ...
    let loaderConfigSnippet = this._getLoaderHtmlSnippet(loaderSettings, isCdnDisabled);
  ...
  _getLoaderHtmlSnippet(loaderSettings, isCdnDisabled) {
    ...
    let getLoaderConfigSnippet = (config, configVarName) => {
      ...
      let loaderConfigSnippet = `var ${configVarName} = ${stringifiedConfig};`;
