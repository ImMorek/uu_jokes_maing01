...
class AppStatusStartupListener {
  async onStartup() {
    if (!statusUpdater.progressUri) {
      ...
      new AlignedInterval((atTime) => statusUpdater.updateAndReset(atTime), appStatusResetPeriod);
      ...
      if (progressUpdatePeriod < appStatusResetPeriod) {
        new AlignedInterval((atTime) => statusUpdater.update(atTime), progressUpdatePeriod);
      }
    }
  }
}
